...
from DiscoFuzzer import RunDisco
from Minimizer import Minimize

from RTLSim.src.adapters.tilelink.adapter import IS_DISCO
...
parser.add_option('disco', IS_DISCO, 'Whether to run disco instead of difuzzrtl')
...
if not multicore:
    if minimize:
        ...
        if parser.arg_map['disco'][0]:
            factory = TestFactory(RunDisco)
        else:
